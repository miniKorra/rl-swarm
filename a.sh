...
if [ "$CONNECT_TO_TESTNET" = true ]; then
    ...
    cp "$ROOT"/modal-login/data/userData.json "$ROOT"/modal-login/temp-data/userData.json    
    cp "$ROOT"/modal-login/data/userApiKey.json "$ROOT"/modal-login/temp-data/userApiKey.json
fi
